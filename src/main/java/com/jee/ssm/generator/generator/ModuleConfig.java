...
import com.jee.ssm.generator.util.DataModuleBuild;
import com.jee.ssm.generator.util.GenUtil;
import com.jee.ssm.generator.util.Path;
...
class ModuleConfig {
    ...
    private void createListJsp(){
        ...
        /*创建一个数据模型 Create a data model */
        Map root = DataModuleBuild.createListJspDataModle(moduleName,clazz);
