...
-- Records of t_power
-- ----------------------------
INSERT INTO `t_power` VALUES ('1074620113840157779', '日志列表', '', '8459272568920914939', '0', '/log/list', '0', 'fa fa-list-ul icon-state-success', 'log:list', '&page=1&size=10');
...
INSERT INTO `t_power` VALUES ('13737', '管理员添加', '管理员添加', '13735', '1', '/admin/add', '2', 'fa  fa-plus icon-state-info', 'admin:add', null);
...
INSERT INTO `t_power` VALUES ('13742', '角色添加', '添加角色', '13740', '1', '/role/add', '2', 'fa  fa-plus icon-state-info', 'role:add', null);
...
INSERT INTO `t_power` VALUES ('8996267916842585978', '测试添加', '', '8981313088726911580', '1', '/test/add', '0', 'fa  fa-plus icon-state-info', 'test:add', null);
