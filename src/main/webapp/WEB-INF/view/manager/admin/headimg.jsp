...
<div class="page-container">
            ...
            <div class="portlet light">
                ...
                <div class="portlet-body form">
                    <form action="#" class="form-horizontal" id="editForm-head">
                        <div class="form-body">
                            <div class="form-group frist">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img class="img-responsive" id="editImg" alt="预备头像"
                                         src="/images/account/no-img.jpg">
                                ...
                                <div class="col-md-2 hide" id="cParam">
                                    <table>
                                        <tr>
                                            ...
                                            <td><input type="text" id="id" name="id" value="${data.id}"
                                                       class="input-xsmall"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="imgCutParam" type="text" id="x1" name="x1"
                                                       class="input-xsmall">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;">y1：</td>
                                            <td><input class="imgCutParam" type="text" id="y1" name="y1"
                                                       class="input-xsmall">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;">x2：</td>
                                            <td><input class="imgCutParam" type="text" id="x2" name="x2"
                                                       class="input-xsmall">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;">y2：</td>
                                            <td><input class="imgCutParam" type="text" id="y2" name="y2"
                                                       class="input-xsmall">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;">w：</td>
                                            <td><input class="imgCutParam" type="text" id="w" name="w"
                                                       class="input-xsmall">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;">h：</td>
                                            <td><input class="imgCutParam" type="text" id="h" name="h"
                                                       class="input-xsmall">
                                            </td>
                                        </tr>
        ...
        tools.post("/admin/changeHead", param, function (data) {
            if (data.success) {
                try {
                    ...
                    $("#myHeadImg", window.parent.document).attr("src", "/sysImage/showImg?src=" + data.data);
                } catch (e) {
