...
import com.jee.ssm.modules.ssm.dao.SettingsDao;
...
public class SettingsService extends BaseService<Settings> {
    ...
    */
    public Settings selectById(String id) {
    ...
    */
    public PageInfo<Settings> list(Map map) {
    ...
    * @throws Exception 数据返回异常
    */
    public PageInfo<Settings> list(Map map,int page,int size) {
