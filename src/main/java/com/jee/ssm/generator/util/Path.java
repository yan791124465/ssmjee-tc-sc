...
public class Path {
    ...
    private static final String code = home + "/java/com/jee/ssm/modules";
    private static final String resources = home + "/resources";
    private static final String jsp = home + "/webapp/WEB-INF/view";
    ...
    static String jspPkg = "/manager";

    //模板文件夹路径 需要先获取
    public static final String ftlPath = sysDir + "/src/main/java/com/jee/ssm/generator/template";
    ...
    //包路径
    private static final String baseImport = "com.jee.ssm.";
    static final String modelImport = "com.jee.ssm.model.";
